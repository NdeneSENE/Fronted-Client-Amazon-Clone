                  ...
                  >
                    ...
                    >
                      ...
                      <div class="edit-address-desktop-link">
                        <nuxt-link :to="`/adress/${address._id}`"
                          >Edit</nuxt-link
                        >&nbsp; | &nbsp;
                        <a href="#" @click="onDeleteAdress(address._id, index)"
                          >Delete</a
                        >
                        &nbsp; | &nbsp;
...
export default {
  ...
  methods: {
    async onDeleteAdress(id, index) {
      try {
        let response = await this.$axios.$delete(`/api/adresses/${id}`);
        if (response.success) {
    ...
    async onSetDefault(id) {
      try {
        let response = await this.$axios.$put(`/api/adresses/set/default`, {
          id: id
        });
        if (response.success) {
          this.message = response.message;
