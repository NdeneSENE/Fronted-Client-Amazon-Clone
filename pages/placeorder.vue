                      ...
                      <div class="a-row">
                        <div class="displayAddressDiv">
                          ...
                          <ul class="displayAddressUL">
                            <li>{{ $auth.$state.user.adress.fullName }}</li>
                            <li>
                              {{ $auth.$state.user.adress.streetAddress }}
                            </li>
                            <li>{{ $auth.$state.user.adress.city }}</li>
                            <li>{{ $auth.$state.user.adress.country }}</li>
                            <li>
                              Phone:
                              <span dir="ltr">{{
                                $auth.$state.user.adress.phoneNumber
                              }}</span>
                            </li>
                          </ul>
                        </div>
